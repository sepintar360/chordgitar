...
$(document).ready(function() {
				...
				$('#promokhususatas').append('<style>.sharingmedia{padding-top:5px;padding-left:20px;padding-right:20px;padding-bottom:5px;color:white;border-radius:0.1em;-moz-border-radius:0.1em;-webkit-border-radius:0.1em;-khtml-border-radius:0.1em;font-weight:bold;}</style><div style="background-color:#edd393;margin-top:-5px;padding-top:8px;padding-bottom:2px;"><center style="padding:5px"><b class="sharingmedia" style="background-color:#996633;">Share:</b> <a href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fkuncilagu.exe.bz"><Span class="sharingmedia" style="background-color:#2988bc;">FB</span></a> <a href="https://twitter.com/intent/tweet?text=%23Chord+%23Guitar+and+%23Lyric+%23'+tampilchord[idchord]["nama_band"]+' - '+tampilchord[idchord]["judul"]+'&via=moreshare&url=http://kuncilagu.exe.bz/'+tampilchord[idchord]["id"]+'"><Span class="sharingmedia" style="background-color:#09b8c1;">Twit</span></a> <a href="https://wa.me/?text=[Chord+Guitar]+'+tampilchord[idchord]["nama_band"]+'+-+'+tampilchord[idchord]["judul"]+'.+LIHAT+DISINI:+http://kuncilagu.exe.bz/'+tampilchord[idchord]["id"]+'"><Span class="sharingmedia" style="background-color:#23db3f;">WA</span></a></center><div>');	

				$('#judulchord').append(""+tampilchord[idchord]['nama_band']+" - "+tampilchord[idchord]['judul']+"");	
				$('#listensong').append("<center><a href=\"https://www.youtube.com/results?search_query="+(tampilchord[idchord]['nama_band'].replace(/\'/g, "\\'"))+" "+(tampilchord[idchord]['judul'].replace(/\'/g, "\\'"))+"\"><img style=\"width:90%;margin-top:10px;margin-bottom:10px;\" src=\"listen.png\"></a><br>"+localStorage.getItem('advertisechord')+"</center>");
				/********************/
